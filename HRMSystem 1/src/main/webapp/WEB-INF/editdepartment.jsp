...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/editNewDepartment" method="POST">
		<p class="text-center" style="font-size:35px"><b>Thêm Phòng Ban</b></p>
		<br/>
        <div class="row">
			<div class="col-md-5"></div>
			<div class="col-md-4">
				<div class="row">
					<div class="col-md-3"><label for="fname">Mã phòng ban:</label></div>
					<div class="col-md-5"><input type="text" id="mpb" name="mpb" value="${de.dId }"><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tên Phòng Ban:</label></div>
					<div class="col-md-5"><input type="text" id="name" name="name" value="${de.dName }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Ghi Chú:</label></div>
					<div class="col-md-5">
						<input type="text" id="note" name="note" value="${de.dNote }"><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Quản Lý:</label></div>
					<div class="col-md-5"><input type="text" id="manager" name="manager" value="${de.dManager }"><br><br></div>
				</div>
