...
<body onload="time()">
	...
	<Br>
	<Br>
		<p class="text-center" style="font-size:35px"><b>Bảng Lương</b></p>
		<br/>
		<br/>
		<a href="/HrmSystem/addSalary">Thêm mới lương</a>
		<br/>
		<br/>
        <table class="table table-bordered" id="myTable">
            ...
            <c:forEach items="${sas }" var="sa">
                <tr>
                    ...
                    <td>${sa.sSalary }</td>
                    <td>
                        <a class="edit" title="Sửa" data-toggle="tooltip" href="/HrmSystem/editSalary?id=${sa.id }"><i class="fa fa-pencil"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".edit", function () {
				...
				window.location.href = 'editsalary.html';
            });
            jQuery(function () {
