...
<head>
    ...
    <title>Đơn Từ | Quản Lý Nhân Viên</title>
...
<body onload="time()">
	...
	<Br>
	<Br>
		<p class="text-center" style="font-size:35px"><b>Danh Sách Đơn Từ</b></p>
		<br/>
		<a href="/HrmSystem/addRequest">Thêm mới đơn từ</a>
		<br/>
		<br/>
        <table class="table table-bordered" id="myTable">
            <thead>
                <tr class="ex">
					<th width="auto">MSNV</th>
                    <th>Tên nhân viên</th>
                    <th>Ngày Tháng</th>
                    <th>Loại đơn</th>
					<th>Lý do</th>
            ...
            <c:forEach items="${res }" var="re">
                <tr>
					...
					<td>${re.approver }</td>
                    <td>
						<a href="/HrmSystem/editRequest?id=${re.id }" title="Duyệt đơn"><i class="fa fa-pencil"
