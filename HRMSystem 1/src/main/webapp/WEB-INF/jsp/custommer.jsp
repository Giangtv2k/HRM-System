            ...
            <tbody>
            	<c:forEach items="${staffs}" var="staff">
            		<tr>
	                    ...
	                    <td>
	                        <a class="edit" title="Sửa" data-toggle="tooltip" href="/HrmSystem/editNewUser?sid=${staff.id }"><i class="fa fa-pencil"
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
					...
					'<td><input type="text" class="form-control" name="chucvu" id="chucvu" value="" placeholder="Nhập Phòng Ban"></td>' +
                    '<td>' + actions + '</td>' +
                    '</tr>';
                $("table").append(row);
                $("table tbody tr").eq(index + 1).find(".add, .edit").toggle();
                $('[data-toggle="tooltip"]').tooltip();*/
				window.location.href = '/HrmSystem/addUser';
            });
            //Add Hàng
            ...
            //$(document).on("click", ".edit", function () {
				...
				//window.location.href = '/HrmSystem/editUser?msvn='+{$};
            //});
            jQuery(function () {
