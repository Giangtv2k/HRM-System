...
<body onload="time()">
	...
	<Br>
	<Br>
		<p class="text-center" style="font-size:35px"><b>Chấm Công</b></p>
		<br/>
		<br/>
		<a href="/HrmSystem/addattendance">Thêm mới chấm công</a>
		<br/>
		<br/>
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
            	<c:forEach items="${atens}" var="aten">
            		<tr>
                    <td>${aten.uId}</td>
                    <td>${aten.aDate }</td>
                    <td>${aten.sHour }</td>
                    ...
                    <td>${aten.workTime}</td>
                    <td>
                        <a class="edit" title="Sửa" data-toggle="tooltip" href="/HrmSystem/editAttendance?id=${aten.id }"><i class="fa fa-pencil"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".edit", function () {
				...
				window.location.href = 'editattendance.html';
            });
            jQuery(function () {
