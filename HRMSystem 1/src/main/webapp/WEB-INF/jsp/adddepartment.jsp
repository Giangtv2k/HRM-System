...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/addNewDepartment" method="POST">
        ...
        <div class="row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="mpb" name="mpb"><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tên Phòng Ban:</label></div>
					<div class="col-md-5"><input type="text" id="name" name="name"><br><br></div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="manager" name="manager"><br><br></div>
				</div>
				<div class="row">
