...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/addNewAttendance" method="POST">
        ...
        <div class="row">
			...
			<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="date" id="date" name="date" value=""><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Giờ vào:</label></div>
					<div class="col-md-5">
						<input type="text" id="sHour" name="sHour" value=""><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Giờ ra:</label></div>
					<div class="col-md-5"><input type="text" id="eHour" name="eHour" value=""><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Work Time:</label></div>
					<div class="col-md-5"><input type="text" id="wTime" name="wTime" value=""><br><br></div>
				</div>
				<div class="row">
