...
<body onload="time()">
	...
	<Br>
	<Br>
		<p class="text-center" style="font-size:35px"><b>Danh Sách Phòng Ban</b></p>
		<br/>
		<br/>
		<a href="/HrmSystem/addDepartment">Thêm mới phòng ban</a>
		<br/>
		<br/>
        <table class="table table-bordered" id="myTable">
            ...
            <c:forEach items="${des }" var="de">
                <tr>
                    <td><a href="devstaff.html">${de.dId}</a></td>
                    <td>${de.dName }</td>
                    <td>${de.dNote }</td>
					<td>${de.dManager}</td>
                    <td>
                        <a class="edit" title="Sửa" data-toggle="tooltip" href="/HrmSystem/editDepartment?id=${de.id }"><i class="fa fa-pencil"
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".edit", function () {
               /* $(this).parents("tr").find("td:not(:last-child)").each(function () {
				...
				window.location.href = 'editdepart.html';
            });
            jQuery(function () {
