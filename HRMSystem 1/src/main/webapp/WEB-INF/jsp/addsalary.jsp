...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/addNewSalary" method="POST">
        ...
        <div class="row">
			...
			<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="date" name="date" value=""><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tổng giờ làm:</label></div>
					<div class="col-md-5">
						<input type="text" id="sTime" name="sTime" value=""><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Hệ số:</label></div>
					<div class="col-md-5"><input type="text" id="heso" name="heso" value=""><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Thưởng/Phạt:</label></div>
					<div class="col-md-5"><input type="text" id="bonus" name="bonus" value=""><br><br></div>
				</div>
				<!-- <div class="row">
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="sumSa" name="sumSa" value=""><br><br></div>
				</div>
				<div class="row">
