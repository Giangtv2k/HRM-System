...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/editNewBonus" method="POST">
		<p class="text-center" style="font-size:35px"><b>Thêm Thưởng Phạt</b></p>
		<br/>
        <div class="row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="msnv" name="msnv" value="${bo.staffId }"><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Ngày tháng:</label></div>
					<div class="col-md-5"><input type="date" id="date1" name="date1" value="${bo.bDate }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Loại:</label></div>
					<div class="col-md-5">
				...
				<div class="row">
					<div class="col-md-3"><label for="lname">Số tiền:</label></div>
					<div class="col-md-5"><input type="text" id="money" name="money" value="${bo.bMoney }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Nội dung:</label></div>
					<div class="col-md-5"><textarea id="note" name="note" rows="6" cols="50">${bo.content }</textarea><br><br></div>
				</div>
