...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/editNewRequest" method="POST">
		<p class="text-center" style="font-size:35px"><b>Duyệt Đơn Từ</b></p>
		<br/>
        <div class="row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="msnv" name="msnv" value="${re.staffId }" readonly><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tên Nhân Viên:</label></div>
					<div class="col-md-5"><input type="text" id="name" name="name" value="${re.staffname }" readonly><br><br></div>
				</div>
				<div class="row">
					...
					<div class="col-md-5">
						<select class="form-select" aria-label="Default select example" name="type">
						  ...
						  <option value="3">Không đồng ý</option>
						</select><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Ghi chú:</label></div>
					<div class="col-md-5"><textarea id="note" name="note" rows="6" cols="50">${re.note }</textarea><br><br></div>
				</div>
