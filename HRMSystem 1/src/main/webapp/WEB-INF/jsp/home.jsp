        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="text-center p-t-135">
                    <a class="txt2" href="#">
                        2021 <i class="fa fa-copyright" aria-hidden="true"></i>  Design by Group 7
                    </a>
                </div>
                </form>
            </div>
   ...
   <script type="text/javascript">
    function validate() {
        ...
        if (username == "admin" && password == "123456789") {
            ...
            window.location = "/HrmSystem/homepage";
            return true;
        }
        if(username == "tuanla01" && password == "123456789") {
            swal("Thành Công!", "Bạn Đã Đăng Nhập Với Tư Cách Quản Lý", "success");
            window.location = "/HrmSystem/homepage"
            return true;
        }
