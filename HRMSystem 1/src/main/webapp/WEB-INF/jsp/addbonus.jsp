...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/addNewBonus" method="POST">
        ...
        <div class="row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="msnv" name="msnv"><br></div>
				</div>
				<br/>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-5"><input type="text" id="money" name="money"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Nội dung:</label></div>
					<div class="col-md-5"><textarea id="note" name="note" rows="6" cols="50"></textarea><br><br></div>
				</div>
				<div class="row">
