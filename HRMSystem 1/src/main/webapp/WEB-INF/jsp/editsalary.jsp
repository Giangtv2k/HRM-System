...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/editNewSalary" method="POST">
		<p class="text-center" style="font-size:35px"><b>Thêm Mới Lương</b></p>
		<br/>
        <div class="row">
			<div class="col-md-5"></div>
			<div class="col-md-4">
				<div class="row">
					<div class="col-md-3"><label for="fname">Mã Nhân Viên:</label></div>
					<div class="col-md-5"><input type="text" id="msnv" name="msnv" value="${sa.staffId }"><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tháng:</label></div>
					<div class="col-md-5"><input type="text" id="date" name="date" value="${sa.month }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Tổng giờ làm:</label></div>
					<div class="col-md-5">
						<input type="text" id="sTime" name="sTime" value="${sa.sWorkTime }"><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Hệ số:</label></div>
					<div class="col-md-5"><input type="text" id="heso" name="heso" value="${sa.heso }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Thưởng/Phạt:</label></div>
					<div class="col-md-5"><input type="text" id="bonus" name="bonus" value="${sa.bonus }"><br><br></div>
				</div>
				<!-- <div class="row">
					<div class="col-md-3"><label for="lname">Phạt:</label></div>
					<div class="col-md-5"><input type="text" id="minus" name="minus" value=""><br><br></div>
				</div> -->
				<div class="row">
					<div class="col-md-3"><label for="lname">Tổng lương:</label></div>
					<div class="col-md-5"><input type="text" id="sumSa" name="sumSa" value="${sa.sSalary }"><br><br></div>
				</div>
