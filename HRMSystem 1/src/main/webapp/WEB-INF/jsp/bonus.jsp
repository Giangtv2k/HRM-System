...
<body onload="time()">
	...
	<Br>
	<Br>
		<p class="text-center" style="font-size:35px"><b>Thưởng Phạt</b></p>
		<br/>
		<a href="/HrmSystem/addBonus">Thêm mới thưởng phạt</a>
		<br/>
		<br/>
            ...
            <c:forEach items="${bos }" var="bo">
                <tr>
                    ...
                    <td>
                        ...
                        <a class="edit" title="Sửa" data-toggle="tooltip" href="/HrmSystem/editBonus?id=${bo.id }"><i class="fa fa-pencil"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".edit", function () {
				...
				window.location.href = 'editbonus.html';
            });
            jQuery(function () {
