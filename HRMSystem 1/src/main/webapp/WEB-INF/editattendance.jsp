...
<body onload="time()">
	...
	<Br>
	<Br>
	<form action="/HrmSystem/editNewAttendance" method="POST">
		<p class="text-center" style="font-size:35px"><b>Thêm Mới Chấm Công</b></p>
		<br/>
        <div class="row">
			<div class="col-md-5"></div>
			<div class="col-md-4">
				<div class="row">
					<input type="hidden" value="${at.id }" name="id" id="id">
					<div class="col-md-3"><label for="fname">Mã Nhân Viên:</label></div>
					<div class="col-md-5"><input type="text" id="msnv" name="msnv" value="${at.uId }"><br></div>
				</div>
				<br/>
				<div class="row">
					<div class="col-md-3"><label for="lname">Ngày Tháng:</label></div>
					<div class="col-md-5"><input type="date" id="date" name="date" value="${at.aDate }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Giờ vào:</label></div>
					<div class="col-md-5">
						<input type="text" id="sHour" name="sHour" value="${at.sHour }"><br><br>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Giờ ra:</label></div>
					<div class="col-md-5"><input type="text" id="eHour" name="eHour" value="${at.eHour }"><br><br></div>
				</div>
				<div class="row">
					<div class="col-md-3"><label for="lname">Work Time:</label></div>
					<div class="col-md-5"><input type="text" id="wTime" name="wTime" value="${at.workTime }"><br><br></div>
				</div>
				<div class="row">
